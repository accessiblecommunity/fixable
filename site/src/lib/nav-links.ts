...
export const checkIsNavLink = (entry: NavLink | NavParent): entry is NavLink => 'href' in entry;

/** Utility function to recursively filter links (not parents) in a NavTree structure. */
export const filterNavTreeLinks = (navTree: NavTree, fn: (entry: NavLink) => boolean) =>
  navTree
