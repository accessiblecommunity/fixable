...
// biome-ignore lint/suspicious/noExplicitAny: Astro component signatures require any
 ...
 */
export type PolymorphicProps<Tag extends TagOrComponent> = Tag extends HTMLTag
  ? Polymorphic<{ as: Tag }>
